...
// default filters
ValidatorFilters.register(
    'onEnterStep',
    (ctx, step) => ctx.nextStep === step
);

ValidatorFilters.register(
    'onExitStep',
    (ctx, step) => ctx.prevStep === step
);
...
export function hydrateFromSnapshot(engine, snapshot = {}, options = {})
{
    ...
    {
        console.warn('[stateEngine] hydrateFromSnapshot: snapshot missing or invalid');
        return;
    }
