<template>
  ...
  >
    <div class="flex w-full h-full">
      ...
      <div
        :class="['hidden ipad-portrait:hidden lg:flex lg:max-w-[20.375rem] flex-col gap-4 px-2 lg:px-6 lg:pt-4 xl:pt-4 pb-[4rem] md:px-4 h-full', !embedded && 'lg:pt-6 xl:pt-12']"
      >
        <MiniCalendar
          class="md:col-span-1"
