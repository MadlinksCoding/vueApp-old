...
<template>
    ...
    >
        <ToastHost />
        <div :class="[embedded ? '' : '', 'flex w-full h-full md:h-auto flex-col lg:flex-row gap-4 lg:gap-0']">
            <div
                :class="[
                    embedded
                        ? 'flex h-full flex-col gap-6 relative w-full lg:w-[40vw] lg:min-w-[31.25rem] lg:max-w-[45rem] bg-white/50 shadow-[0px_4px_6px_-2px_rgba(16,24,40,0.03)] backdrop-blur-[1.563rem] lg:overflow-y-auto overflow-x-hidden lg:no-scrollbar lg:h-dvh lg:max-h-dvh'
                        : 'flex h-full flex-col gap-6 relative w-full lg:w-[40vw] lg:min-w-[31.25rem] lg:max-w-[45rem] bg-white/50 shadow-[0px_4px_6px_-2px_rgba(16,24,40,0.03)] backdrop-blur-[1.563rem] lg:overflow-y-auto overflow-x-hidden lg:no-scrollbar lg:h-dvh lg:max-h-dvh'
                ]">
