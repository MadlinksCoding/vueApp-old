...
<template>
  <div class="flex flex-col gap-6 relative">
    ...
    <BookingSectionsWrapper
      ...
      accordionIcon="https://i.ibb.co/MD46QRZS/Frame-1410099649.png"
      :is-open="sectionsState.audienceSettings"
      @toggle="toggleSection('audienceSettings')"
    >
      <div
        v-show="sectionsState.audienceSettings"
      ...
      <div v-show="sectionsState.xRepost" class="flex flex-col gap-5 mt-5">
          ...
          <div class="inline-flex gap-2">
            ...
            <div class="flex justify-end">
              <img class="w-4 h-5" src="https://i.ibb.co/QFV4GNPF/Icon.png" alt="" />
            </div>
          </div>
