...
onMounted(() => {
  ...
  const initialText = props.publishFlow.state?.description || "";
  ...
  // Styling Fixes (Preserved from original code)
      ...
      <div v-if="substepProxy === 'paid-tier'" class="flex flex-col gap-4 animate-fade-in">
        ...
        <div class="flex-col gap-4 flex">
          ...
          <div class="flex w-full">
            ...
            <BasePlanDropdown 
              v-model="priceDurationProxy" 
              :options="durationOptions" 
              widthClass="w-[11.25rem]" 
            />
          </div>
        </div>
    ...
    <section class="flex flex-col gap-4 px-2 py-4 bg-white/25 group/wrapper md:gap-6 md:p-4 dark:bg-[#181a1b40]">
      ...
      <div class="flex flex-col gap-4">
        <div class="flex flex-col gap-2">
          ...
          <p class="text-sm text-[#475467] dark:text-[#b1aba0]">Offer discount to your subscribers when they unsubscribe from this tier.</p>
        </div>
        <div class="flex flex-col gap-4 pb-2">
             <div class="flex items-center gap-2">
                <div>
      ...
      <div class="flex flex-col gap-4 backdrop-blur-[25px] md:gap-6">
        ...
        <div class="grid grid-cols-[repeat(auto-fit,minmax(15.25rem,1fr))] items-center gap-2 w-full">
          ...
          <InputDefaultComponent
            id="input_free_tokens"
            type="number"
            v-model="freeTokensProxy"
            rightSpan
            :rightSpanText="'% off'"
            ...
            :showLabel="false"
            :error="freeTokensError"
            error-message="Value must be between 1-99"
            rightSpanClass="text-[16.5px] font-semibold whitespace-nowrap px-[1.125rem] text-[#344054] dark:text-[#bdb7af]"
            inputClass="text-[#0C111D] font-600 text-base" 
            errorMessageClass="text-[#FF4405] dark:text-[#ff571e]"
          />
        </div>
        ...
        <div class="grid grid-cols-[repeat(auto-fit,minmax(15.25rem,1fr))] items-center gap-2 w-full">
          ...
          <div class="h-11 flex items-center bg-white/30 border-b border-[#D0D5DD] rounded-t-sm shadow-[0px_1px_2px_0px_#1018280D] dark:bg-[#181a1b4d] dark:border-[#3b4043]">
            <input type="text" v-model="payToViewDiscountProxy" class="text-base bg-transparent border-none outline-none w-full min-w-0 px-3.5 text-[#0C111D] placeholder:text-[#667085] dark:text-[#dbd8d3] dark:placeholder:text-[#9e9689]">
        ...
        <div class="grid grid-cols-[repeat(auto-fit,minmax(15.25rem,1fr))] items-center gap-2 w-full">
          ...
          <div class="h-11 flex items-center bg-white/30 border-b border-[#D0D5DD] rounded-t-sm shadow-[0px_1px_2px_0px_#1018280D] dark:bg-[#181a1b4d] dark:border-[#3b4043]">
            <input type="text" v-model="customRequestDiscountProxy" class="text-base bg-transparent border-none outline-none w-full min-w-0 px-3.5 text-[#0C111D] placeholder:text-[#667085] dark:text-[#dbd8d3] dark:placeholder:text-[#9e9689]">
            <span class="text-base font-semibold whitespace-nowrap px-[1.125rem] text-[#344054] dark:text-[#bdb7af]">% off</span>
          </div>
        </div>
      </div>
