  ...
  >
  <div
    class="h-full bg-black/80 font-sans p-0 m-0 box-border overflow-x-hidden overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-order-style:none] [scrollbar-width:none]"
  >
    <!-- popup-wrapper -->
    <div
    ...
    >
      ...
      <div class="flex flex-col w-full relative lg:h-screen lg:bg-[#191919]">
        ...
        <div class="flex justify-between items-center gap-2 p-2 md:hidden">
          ...
          <span class="text-sm font-semibold text-white"
            >cheese pizza asmr</span
          >

          <img
            src="https://i.ibb.co.com/xtn4YLHF/3-dots.webp"
            alt="settings"
            class="w-6 h-6 cursor-pointer"
          />
        </div>
        ...
        <div class="w-full aspect-[16/9] md:hidden">
          <div
            class="relative w-full h-full shadow-[0px_0px_10px_-34px_#0000001A] overflow-hidden"
          >
            <!-- background image -->
            <div
              class="absolute inset-0 bg-[url('https://i.ibb.co.com/Kx9QDc68/auth-bg-compressed.webp')] bg-cover bg-center"
            ></div>
            ...
            <div
              class="w-full h-full flex flex-col justify-between gap-2 relative z-[1]"
            >
              <!-- overlay-items__top -->
              <div class="w-full flex justify-between items-center gap-3 p-1">
                ...
                >
                  <img
                    src="https://i.ibb.co.com/tTDV6Ms1/play-square.webp"
                    alt="video"
                    class="w-4 h-4"
                  />
                  <span
                    class="text-xs leading-normal font-medium text-white tracking-[0.015rem] align-middle"
                    >15:00:03</span
                  >
                </div>
                ...
                <div class="flex items-center gap-3 px-1 opacity-70">
                  <!-- likes -->
                  <div
                    class="flex items-center gap-[0.1875rem] drop-shadow-[0px_0px_5px_0px_#000000]"
                  >
                    <img
                      src="https://i.ibb.co.com/YFwpWQnM/heart.webp"
                      alt="likes"
                      class="w-3 h-3"
                    />
                    <span
                  ...
                  >
                    <img
                      src="https://i.ibb.co.com/rB3cvGp/eye.webp"
                      alt="views"
                      class="w-3 h-3"
                    />
                    <span
              ...
              <div class="flex justify-end items-center">
                <!-- logo -->
                <img
                  src="https://i.ibb.co.com/wr75MHTr/logo.webp"
                  alt="logo"
                  class="h-16"
                />
              </div>
        ...
        <div class="hidden w-full md:block">
          <!-- background image -->
          <div
            class="absolute w-full aspect-[16/9] inset-0 bg-[url('https://i.ibb.co.com/Kx9QDc68/auth-bg-compressed.webp')] bg-cover bg-center lg:h-screen"
          ></div>

          <!-- bg-overlay -->
          <div
            class="absolute w-full aspect-[16/9] inset-0 bg-[linear-gradient(180deg,rgba(0,0,0,0)_0%,rgba(0,0,0,0.9)_100%),linear-gradient(0deg,rgba(0,0,0,0.2),rgba(0,0,0,0.2))] lg:h-screen"
          ></div>
          ...
          >
            ...
            <div class="flex flex-col gap-12 z-[1]">
              <div
                class="flex flex-col gap-2 w-[31.625rem] lg:gap-5 lg:w-[42rem]"
              >
                <!-- avatar & user-info -->
                <div class="flex items-center gap-2 py-1 w-80">
                  ...
                  <div class="flex flex-col">
                    ...
                    <div class="flex items-center gap-1 lg:hidden">
                      <span
                        class="text-xs leading-normal font-semibold text-white"
                    ...
                    <div class="flex items-center gap-2">
                      ...
                      >
                      <img
                        src="https://i.ibb.co.com/KxpZRPLz/check-verified-03-filled.webp"
                        alt="verified-filled"
                    ...
                    <div class="flex items-center gap-3 lg:hidden">
                      ...
                      <div class="flex items-center gap-1 h-[1.125rem]">
                        <img
                          src="https://i.ibb.co.com/MkhnCTJK/user-02.webp"
                          alt="followers"
                ...
                <!-- text-container -->
                <div
                  class="flex flex-col gap-2 pl-6 border-l-[0.5px] border-white lg:gap-5"
                >
                  <p
                    class="text-base font-semibold line-clamp-2 text-white lg:text-[1.75rem] lg:leading-normal lg:line-clamp-3"
                  >
                    Record breaking fried chicken eating ! See my attempt to
                    break world’s record! Watch now!
                  </p>
                  ...
                  >
                    <span
                      class="text-xs leading-normal capitalize tracking-[0.01875rem] text-white"
                      >11/12/23</span
                    >
                  </div>

                  <p
                    class="text-xs leading-loose tracking-[0.0075rem] text-white lg:text-base"
                  >
                  ...
                  <div class="flex flex-wrap gap-2">
                    ...
                    >
                      <span
                        class="text-xs leading-normal capitalize tracking-[0.01875rem] text-[#E7E5E4]"
                        >Fried Chicken</span
                      >
                    </div>
                  ...
                  <div class="flex items-center gap-2">
                    ...
                    >
                      <img
                        src="https://i.ibb.co.com/pjr9G8tn/upload.webp"
                        alt="upload"
                        class="h-4"
                      />
                    </div>
        ...
        <div
          class="flex flex-col gap-4 px-2 pt-3 pb-6 md:gap-6 md:px-4 md:py-6 lg:hidden"
        >
          <!-- media-details__top-container -->
          <div class="flex flex-col gap-2 md:hidden">
            <h2
              class="text-base tracking-[0.01rem] line-clamp-3 text-[#F5F5F4]"
            >
            ...
            <div class="flex items-center gap-2 h-9">
              ...
              <div class="flex flex-col">
                ...
                <div class="flex items-center gap-4">
                  <!-- followers -->
                  <div
                    class="flex items-center gap-[0.1875rem] drop-shadow-[0px_0px_5px_0px_#000000] h-[1.125rem]"
                  >
                    <img
                      src="https://i.ibb.co.com/MkhnCTJK/user-02.webp"
                      alt="followers"
      ...
      <div class="flex mt-4 w-full px-2">
        <div class="flex flex-col gap-2 w-full">
          <!-- title-container -->
          <div
            class="flex justify-between items-center py-1 gap-4 min-[580px]:justify-start"
          >
            <span class="text-sm font-semibold text-white"
              >More from
              <a href="" class="text-sm font-semibold text-[#FB5BA2]"
                >Princess Carrot Pop</a
              ></span
            >

            <span class="text-xs leading-[1.25rem] font-bold text-[#FB5BA2]"
              >View All</span
            >
          </div>
            ...
            <div class="flex flex-col gap-2 w-full">
              ...
              >
                ...
                >
                  ...
                  <!-- media-stats -->
                  <div
                    class="flex items-center gap-[0.813rem] px-1 drop-shadow-[0_0_20px_rgba(0,0,0,0.25)] opacity-70"
                  >
                    <div class="flex items-center gap-[0.813rem] px-1">
                      <span
                        class="flex justify-center items-center gap-[0.188rem] filter drop-shadow-[0_0_.313rem_#000]"
                      >
                        <img
                      ...
                      <span
                        class="flex justify-center items-center gap-[0.1875rem] filter drop-shadow-[0_0_.313rem_#000]"
                      >
                        <img
                ...
                <div class="absolute bottom-0 right-0 z-[10000]">
                  <img
                    src="https://i.ibb.co.com/3m62Qzvz/site-logo.webp"
                    alt="site-logo"
                      ...
                      <div class="flex items-start gap-3 flex-grow">
                        <div class="flex items-center gap-1">
                          <img
                            src="https://i.ibb.co.com/Kjv16vLZ/eye.webp"
                            alt="eye"
                            class="w-[0.875rem] [filter:brightness(100%)_saturate(0)]"
                          />
