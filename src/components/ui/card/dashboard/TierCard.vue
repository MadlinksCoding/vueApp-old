  ...
  >
    ...
    >
      ...
      >
          ...
          <div class="flex items-center z-[1] w-full min-h-[5rem]">
            <div class="flex flex-col gap-2 pl-2 py-2 w-full">
              <div class="flex flex-col">
                ...
                <p
                  class="text-[0.65625rem] leading-[1.125rem] text-white dark:text-[#e8e6e3]"
                >
        ...
        >
          <span
            class="text-sm font-semibold text-white dark:text-[#e8e6e3]"
            :class="tier.id === 5 ? 'text-[#07F468] dark:text-[#06c454]' : ''"
            >FEATURED</span
          >
        </div>
      </div>
