    ...
    >
      <div class="flex flex-col py-1">
        <div class="flex justify-center items-center p-2">
          <h1
            class="text-sm font-semibold text-[#667085] md:text-[#EAECF0] dark:text-[#a0aec0] dark:md:text-[#dddad5]"
          >
        ...
        <div class="flex flex-col gap-4 px-3 py-2">
          <p
            class="text-base font-medium text-[#0C111D] md:text-[#F9FAFB] dark:text-[#dbd8d3] dark:md:text-[#dddad5]"
          >
          ...
          <div class="flex flex-col gap-2">
            <span
              class="text-xs leading-normal font-medium text-[#667085] md:text-[#98A2B3] dark:text-[#a0aec0] dark:md:text-[#b0a99e]"
            ...
            >
              ...
              >
                <img
                  src="https://i.ibb.co.com/p6RVnpkx/logo-1.webp"
                  alt="logo (1)"
              ...
              >
                ...
                >
                  ...
                  >
                    Library of LOREM LPSUM ATIER dolor sit amet, consectetur
                    adipiscing elit.
                  </h3>
              ...
              >
                ...
                >
                  <h3
                    class="text-sm font-semibold line-clamp-2 text-white dark:text-[#e8e6e3]"
                  >
                    FEATURED library of LOREM LPSUM ATIER dolor sit amet,
      ...
      <div class="flex items-center gap-2.5 p-2 md:px-4 md:py-3">
        ...
        >
          <span
            class="text-lg font-medium text-[#07F468] group-hover/button:text-black group-[.disabled]/button:text-white/30 dark:text-[#23f97b] dark:group-hover/button:text-[#e8e6e3] dark:group-[.disabled]/button:text-[#e8e6e3]/30"
            >Cancel</span
          >
        </button>
        <button
