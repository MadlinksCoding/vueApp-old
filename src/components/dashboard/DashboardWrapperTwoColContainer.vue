<template>
  ...
  <div class="dashboard-two-col-container min-h-screen flex">
    ...
    <!-- Body / Main Content -->
    <div class="flex-1 p-4 bg-[#F9FAFBE5] min-h-screen md:bg-transparent md:h-auto dark:bg-background-dark-app before:content-[''] 
        before:fixed before:bg-[url('https://i.ibb.co.com/dw910Z5b/gradient-main-bg.webp')]
         ...
         before:left-0 before:top-0 before:pointer-events-none dark:before:bg-none">
      <slot />
    </div>
  </div>
</template>
